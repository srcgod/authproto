...
const file_user_proto_rawDesc = "" +
	...
	"\fdisplay_name\x18\x03 \x01(\tR\vdisplayName2\xab\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aGetUser\x12\x14.auth.GetUserRequest\x1a\x15.auth.GetUserResponseB\x17Z\x15oneway/auth/v1;authv1b\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auth.GetUser:input_type -> auth.GetUserRequest
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.GetUser:output_type -> auth.GetUserResponse
